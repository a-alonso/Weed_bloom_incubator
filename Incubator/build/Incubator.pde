// Set for the INFRARED LIGHTING
int ledPin = 8;  // LED connected to the Wiring I/O board pin 8

// Set for the LED MATRIX

int bits[8] = { 
  128, 64, 32, 16, 8, 4, 2, 1 };

int clock = 23;  // pin SCK del display
int data = 21;   // pin DI del display
...
void loop()
{
  // Loop for the INFRARED LIGHTING
